...
type TemplateService interface {
	...
	ListTemplates(user *string, chainType, keyword string, limit int) ([]models.Template, error)
...
func (s *templateService) ListTemplates(user *string, chainType, keyword string, limit int) ([]models.Template, error) {
