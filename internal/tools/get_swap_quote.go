...
func NewGetSwapQuoteTool(chainService services.ChainService, liquidityService services.LiquidityService, uniswapService services.UniswapService) (mcp.Tool, server.ToolHandlerFunc) {
